...
public class LocalStack extends Stack {
    ...
    private DatabaseInstance createDatabaseInstance(String id, String name) {
                ...
                ContainerDefinitionOptions.builder()
                        ...
                        .logging(LogDriver.awsLogs(AwsLogDriverProps.builder()
                                .logGroup(LogGroup.Builder.create(this, id + "LogGroup")
                                        ...
                                        .removalPolicy(RemovalPolicy.DESTROY)
                                        .retention(RetentionDays.ONE_DAY) //any valability time to be able to restore
                                        .build())
    ...
    private void createApiGatewayService() {
        ...
        ApplicationLoadBalancedFargateService apiGateway =
                ApplicationLoadBalancedFargateService.Builder.create(this, "APIGatewayService")
                        ...
                        .taskDefinition(taskDefinition)
                        .desiredCount(1) // as the trafic incresease, we will increase this value
